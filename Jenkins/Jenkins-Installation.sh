...
cd /tmp ; wget http://downloads.apache.org/maven/maven-3/3.8.6/binaries/apache-maven-3.8.6-bin.tar.gz
cd /tmp ; tar -xzf apache-maven-3.8.6-bin.tar.gz -C /opt
...
echo "MAVEN_HOME=/opt/apache-maven-3.8.6" >> /etc/profile
